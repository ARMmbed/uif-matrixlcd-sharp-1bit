...
#if YOTTA_CFG_HARDWARE_WRD_SCREEN_PRESENT
#define LCD_NAME        YOTTA_CFG_HARDWARE_WRD_SCREEN_SPI_NAME
#define LCD_CS          YOTTA_CFG_HARDWARE_WRD_SCREEN_SPI_CS
#define LCD_DISP        YOTTA_CFG_HARDWARE_WRD_SCREEN_PIN_ENABLE
#define LCD_EXT_COM_IN  YOTTA_CFG_HARDWARE_WRD_SCREEN_PIN_REFRESH
#else
...
#if YOTTA_CFG_HARDWARE_WRD_OUTPUT_COMPARE_PRESENT
